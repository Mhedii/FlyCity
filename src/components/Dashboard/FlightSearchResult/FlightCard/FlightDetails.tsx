    ...
    <div className="grid grid-cols-12 lg:flex justify-between items-center w-full">
      <div className="col-span-12">
        <div className="flex items-center gap-[0.375rem]">
          ...
          />
          <div className="font-bold text-sm lg:text-[1.5rem]">
            {airline.name}
          </div>
        </div>
        <div className="flex items-center gap-[1.063rem] pt-2">
          <div className="text-xs lg:text-[1.188rem] text-gray">
            {airline.flightNumber}
          </div>
          <span className="bg-primary font-normal text-white text-xs lg:text-[0.875rem] px-[0.5rem] xl:px-[1.125rem] py-1 rounded-md">
            {airline.classType}
          </span>
        </div>
      </div>
      <div className="mt-2 lg:mt-0 col-span-12 flex gap-[1.5rem] items-center">
        <div>
          <div className="font-bold leading-none text-sm lg:text-[2.313rem]">
            {departure.time}
          </div>
          <div className="text-gray text-xs lg:text-[1.188rem]">
            {departure.airport}
          </div>
        </div>

        <div className="text-4xl text-primary flex items-center flex-col">
          <div className="relative flex items-center px-[1rem] justify-between mt-4 lg:mt-0 pb-4 lg:pb-0">
          ...
          <div className="text-xs lg:text-[1.188rem] text-gray flex xl:pt-2">
            <p>{duration}</p>

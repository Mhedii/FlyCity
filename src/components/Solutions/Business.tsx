...
const Business: React.FC = () => {
  return (
    <section className="pt-16 pb-10 md:pb-28 bg-[#F7F9FC] text-center ">
      ...
      <div className=" mx-[1rem] lg:mx-[13rem] xxl:mx-[16rem] items-center grid  grid-cols-1 md:grid-cols-2 ">
        ...
        <div className=" grid gap-4 grid-cols-1 md:grid-cols-2  ">
          {businessData.map((item, index) => (
            <div
              key={index}
              className="card shadow-sm bg-white  rounded-xl pl-10 md:pl-6 px-6 py-6 md:py-12 transition-transform hover:scale-105 hover:cursor-pointer text-start "
            >

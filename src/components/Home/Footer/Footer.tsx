...
const Footer: React.FC = () => {
  return (
    <footer className="py-8 pt-[33px] md:pt-[5.688rem] bg-black_1   text-center px-[1.313rem] md:px-[3rem] lg:px-[4rem] xl:px-[8rem] 2xl:px-[15.75rem]">
      <div className="flex  flex-col lg:flex-row gap-[2.838rem]   mb-6 md:mb-0  ">
        <div className="  ">
          <img src={logo} alt="" className="w-[6.25rem] h-[3.582rem]" />
          <div className="flex gap-4 md:gap-3 mt-[2.125rem] mb-[31px] md:mb-[2.606rem] md:max-w-[18rem]  lg:max-w-[20.625rem]  xl:max-w-[24.625rem]">
            <input
              type="text"
              className="max-w-[14.938rem]  p-3 rounded-xl  leading-none text-[14px] lg:text-base xl:text-[1.188rem]"
              placeholder="Email Address"
            />
            <button className="rounded-[8px] bg-primary text-white font-medium md:font-bold px-5 w-full text-base xl:text-xl">
              Subscribe
            </button>
          </div>
        ...
        <div className="">
          <div className=" text-gray_light text-base lg:text-lg xl:text-[1.375rem]  flex flex-col md:flex-row  justify-around gap-[5px] md:gap-[2.75rem] xl:gap-[4.063rem] text-start  ">
            <nav className="leading-[29.2px] md:leading-[2.5rem]">
              <h6 className="text-[19px] md:text-xl xl:text-2xl text-white font-bold mb-2  ">
                About
              </h6>
      ...
      <div className="   border-t-2  border-white text-white  md:mb-[3.066rem] ">
        <div className="grid grid-cols-1 md:grid-cols-12 mt-6  text-[14px] lg:text-xl xl:text-[1.375rem] ">

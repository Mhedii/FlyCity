    ...
    <div className="mb-[6.375rem]">
      <section className="relative  flex flex-col md:flex-row    mx-[1.313rem] lg:mx-[4rem] xl:mx-[8rem] 2xl:mx-[15.75rem]">
        ...
        <div className="relative top-[2.851rem] md:top-0">
          ...
          <div className=" bg-white left-0 md:left-auto  px-2 md:px-[1rem] xl:px-[2rem] 2xl:px-[3.313rem] pt-3 md:pt-[3.563rem] shadow-xl rounded-3xl w-full md:w-[20rem] xl:w-[25rem] 2xl:w-[31.563rem]  md:h-[35.938rem]   md:ml-auto relative md:absolute bottom-0 right-[4.563rem] z-10 ">
            ...
            <form className="flex flex-col ">
              <div className="mb-[33px] md:mb-[1.563rem] xl:mb-[2.563rem]">
              ...
              <Button
                text="Login"
                className="  text-base xl:text-[1.625rem] w-full mt-[2.125rem] h-[48px] lg-[54px] xl:h-[66px] "
              />
            </form>

            <p className="text-[14px] xl:text-base 2xl:text-[1.188rem] pb-6 pd:mb-0  mt-[31px] md:mt-[2.313rem] flex justify-center md:justify-normal  md:ml-3 leading-none">

...
const Hero: React.FC = () => {
  return (
    <div className="mb-[6.375rem]">
      <section className="relative  flex flex-col md:flex-row    mx-[1.313rem] lg:mx-[6rem] xl:mx-[13rem] 2xl:mx-[15.75rem]">
        ...
        <div className="relative top-[2.851rem] md:top-0">
          ...
          <div className=" bg-white left-0 md:left-auto  px-2 md:px-[3.313rem] pt-3 md:pt-[3.563rem] shadow-xl rounded-3xl w-full md:w-[20rem] xl:w-[25rem] 2xl:w-[31.563rem]  md:h-[35.938rem]   md:ml-auto relative md:absolute bottom-0 right-[4.563rem] z-10 ">
            ...
            <form className="flex flex-col ">
              ...
              <div className="flex justify-between items-center text-[14px] md:text-[1.188rem]  mt-5">
            ...
            <p className="text-[14px] md:text-[1.188rem] pb-6 pd:mb-0  mt-[31px] md:mt-[2.313rem] flex justify-center md:justify-normal  md:ml-3 leading-none">
